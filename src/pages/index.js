        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="container max-w-lg px-4 py-32 mx-auto mt-px text-left md:max-w-none md:text-center">
            ...
            <div className="flex flex-col items-center mt-12 text-center">
              ...
              <a href="tel:+905123456789" className="mt-3 text-sm text-indigo-500">Hemen Ara</a>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                  <a href="tel:+905123456789" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto" data-primary="indigo-600" data-rounded="rounded-md">Hemen Ulaş<svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <section id='service' className="py-20 bg-white">
        <div className="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mt-8 space-x-3">
            <a href="tel:+905123456789" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow hover:bg-indigo-700" data-primary="indigo-600" data-rounded="rounded-md">Hemen Ara</a>
            <a href="#services" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-indigo-700 bg-indigo-100 border border-transparent rounded-md hover:bg-indigo-200" data-primary="indigo-600" data-rounded="rounded-md">Daha Fazla Bilgi</a>
          </div>
        </div>
      </section>
